...
public enum ResponseMessage {
    ...
    INVALID_AMOUNT("ERR004", "The amount is invalid for the operation"),
    LOAN_CREDIT_EXCEEDED("ERR005", "The requested loan amount exceeds the available credit limit"),
    ...
    INSUFFICIENT_BALANCE("ERR008", "Insufficient Balance"),
